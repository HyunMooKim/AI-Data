...
금 가격은 t 시점, 예측을 위한 변수는 한달 전의 t-1시점으로 데이터를 정리하였다.
...
이렇게 경향성을 보이는 경우 엑셀에서 차분한 데이터로 바꾸어주었다.
계절성, 경향성 분석을 진행해보는 것도 좋을 것 같다.
...
'''
#분석 변수 설정: 독립-종속
x_data = gold[ [ "DGS10","S&P500","VIX","CRB","goldETF"]]
